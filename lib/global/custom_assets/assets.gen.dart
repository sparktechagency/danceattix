...
class $AssetsIconsGen {
  ...
  SvgGenImage get moneyIconCard =>
      const SvgGenImage('assets/icons/moneyIconCard.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/allCategory.png
  AssetGenImage get allCategory =>
      const AssetGenImage('assets/images/allCategory.png');
  ...
  /// File path: assets/images/onboardingBg.png
  AssetGenImage get onboardingBg =>
      const AssetGenImage('assets/images/onboardingBg.png');
